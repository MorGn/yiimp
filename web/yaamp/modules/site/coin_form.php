...
if ($coin->id)
{
    ...
    else
    {
        ...
        echo "<b>mkdir -p {$coin->conf_folder}</b>\n";
        ...
        echo " \n";
        echo "<b>' | sudo -E tee {$coin->conf_folder}/$program.conf >/dev/null 2>&1</b>\n";
        ...
        echo "<b>You MUST Downloads Daemon file here -></b> {$coin->conf_folder}/{$coin->program}<b>:</b>";
        echo CHtml::opentag("pre");
        echo "<b>~$</b> crontab -l <b>#(list user's crontab)</b>\n";
        echo "<b>~$</b> crontab -e <b>#(edit user's crontab)->(To save the nano changes, press Ctrl+o)-> Enter ->(To exit nano press Ctrl+x)</b>\n";
        echo '<h5 style="color:#1c94c4"</h5>';
        echo "<b>crontab should look like this:</b>\n";
        echo "########################################################################################################################################################################################################\n";
        echo "# @reboot sleep 20 && /home/crypto-data/yiimp/starts/screens.start.sh\n";
        echo "# @reboot source /etc/functions.sh                                                                                                                                                                     #\n";
        echo "# @reboot source /etc/multipool.conf                                                                                                                                                                   #\n";
        echo "# @reboot sleep 20 && /home/crypto-data/yiimp/starts/stratum.start.sh                                                                                                                                  #\n";
        echo "# @reboot sleep 60 && {$coin->conf_folder}/{$coin->program} -datadir={$coin->conf_folder} -conf=$program.conf -daemon -shrinkdebugfile\n";
        echo "########################################################################################################################################################################################################\n\n";
        echo '</h5>';
        echo "<b>Pre-edit under your algorithm, to edit the stratum.start.sh file: (To save the nano changes, press Ctrl+o)-> Enter ->(To exit nano press Ctrl+x)</b>\n";
        echo "<b>~$</b> sudo nano /home/crypto-data/yiimp/starts/stratum.start.sh\n\n";
        echo "<b>CRON create on the command line (stratum.start.sh):</b>\n";
        echo "<b>~$</b> (crontab -l 2>/dev/null; echo \"@reboot sleep 20 && /home/crypto-data/yiimp/starts/stratum.start.sh\") | crontab -\n\n";
        echo "<b>CRON create on the command line (Daemon):</b>\n";
        echo "<b>~$</b> (crontab -l 2>/dev/null; echo \"@reboot sleep 60 && {$coin->conf_folder}/{$coin->program} -datadir={$coin->conf_folder} -conf=$program.conf -daemon -shrinkdebugfile\") | crontab -\n";
        echo "\n";
        echo "<b>If coin fails to start:</b>\n";
        echo "<b>~$</b> {$coin->conf_folder}/{$coin->program} -reindex\n";
        echo CHtml::closetag("pre");

        echo CHtml::tag("hr");
        echo "<b>Daemon Commands</b>:\n";
        echo "<b>You MUST use this format or coins will not work! You MUST Downloads Daemon file here -></b> {$coin->conf_folder}/{$coin->program} ($program-cli)<b>:</b>";
        echo CHtml::opentag("pre");
        echo "To START a coind:\n";
        echo "<b>~$</b> {$coin->conf_folder}/{$coin->program} -datadir={$coin->conf_folder} -conf=$program.conf -daemon -shrinkdebugfile\n\n";
        echo "To STOP a coind:\n";
        echo "<b>~$</b> {$coin->conf_folder}/{$coin->program} -datadir={$coin->conf_folder} -conf=$program.conf stop\n\n";
        echo "To STOP a coind: If your coin has a -cli (bitcoin-cli) file...\n";
        echo "<b>~$</b> {$coin->conf_folder}/$program-cli -datadir={$coin->conf_folder} -conf=$program.conf stop\n\n";
        echo "To run other CLI functions:\n";
        echo "<b>~$</b> {$coin->conf_folder}/$program-cli -datadir={$coin->conf_folder} -conf=$program.conf help\n\n";
        echo " \n";
        echo "To edit the coin.config file: (To save the nano changes, press Ctrl+o)-> Enter ->(To exit nano press Ctrl+x)\n";
        echo "<b>~$</b> sudo nano {$coin->conf_folder}/$program.conf\n";
        echo CHtml::closetag("pre");

        echo CHtml::tag("hr");
        echo "<b>STRATUM [stop|start|restart] algo</b>:";
        echo CHtml::opentag("pre");
        echo "<b>~$</b> screen -ls <b>#(List of running sessions)</b>\n\n";
        echo "<b>~$</b> /usr/bin/stratum stop {$coin->algo}\n";
        echo "<b>~$</b> /usr/bin/stratum start {$coin->algo}\n";
        echo "<b>~$</b> /usr/bin/stratum restart {$coin->algo}\n";
        echo CHtml::closetag("pre");

        echo CHtml::tag("hr");
        echo "<b>SCREENS [stop|start|restart] servicenames</b>:";
        echo CHtml::opentag("pre");
        echo "<b>~$</b> screen -ls <b>#(List of running sessions)</b>\n\n";
        echo "<b>~$</b> screen -X -S <b>servicenames</b> quit <b>#(Kill session)</b>\n";
        echo "<b>~$</b> /usr/bin/screens stop main <b>~$</b> /usr/bin/screens start main <b>~$</b> /usr/bin/screens restart main\n";
        echo "<b>~$</b> /usr/bin/screens stop loop2 <b>~$</b> /usr/bin/screens start loop2 <b>~$</b> /usr/bin/screens restart loop2\n";
        echo "<b>~$</b> /usr/bin/screens stop debug <b>~$</b> /usr/bin/screens start debug <b>~$</b> /usr/bin/screens restart debug\n";
        echo "<b>~$</b> /usr/bin/screens stop blocks <b>~$</b> /usr/bin/screens start blocks <b>~$</b> /usr/bin/screens restart blocks\n";
        echo CHtml::closetag("pre");

        echo CHtml::tag("hr");
        echo "<b>To open a port</b>:";
        echo CHtml::opentag("pre");
        echo "<b>By default even though all stratum algos start on server start, the ports have been blocked by the firewall. Open a port</b>:\n";
        if (empty($coin->dedicatedport))
        {
        echo "<b>~$</b> sudo ufw allow $port/tcp\n";
        }
        else
        {
        echo "<b>~$</b> sudo ufw allow $dedport/tcp\n";
        }
        echo CHtml::closetag("pre");
